...
//         {/* Header Section - Enhanced colors for light/dark modes */}
...
//           {/* Console - Enhanced colors for better visibility */}
//           <div className="h-40 w-full border-t border-gray-200 bg-gray-900 text-gray-100 dark:border-gray-700 dark:bg-black">
//             {/* <Console /> */}
//           </div>
//         </div>
//       </div>
